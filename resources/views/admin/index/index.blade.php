...
<script type="text/javascript">
    var scripts = [null,"{{ URL::asset('assets/js/jquery-ui.custom.min.js') }}","{{ URL::asset('assets/js/jquery.ui.touch-punch.min.js') }}","{{ URL::asset('assets/js/jquery.easypiechart.min.js') }}","{{ URL::asset('assets/js/jquery.sparkline.min.js') }}","{{ URL::asset('assets/js/flot/jquery.flot.min.js') }}",
        "{{ URL::asset('assets/js/flot/jquery.flot.pie.min.js') }}","{{ URL::asset('assets/js/flot/jquery.flot.resize.min.js') }}", null]
